...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { description: @rental.description, name: @rental.name, picture: @rental.picture } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { description: @rental.description, name: @rental.name, picture: @rental.picture } }
